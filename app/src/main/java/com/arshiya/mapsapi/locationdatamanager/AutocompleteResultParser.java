...
/**
 * Created by arshiya on 11/10/2015.
 */
public class AutocompleteResultParser {

    private static final String TAG = AutocompleteResultParser.class.getSimpleName();
    private static AutocompleteResultParser mAutocompleteResultParser =
            new AutocompleteResultParser();
    ...
    /**
     * Parses the Google Places autocomplete result in JSON format
     */
