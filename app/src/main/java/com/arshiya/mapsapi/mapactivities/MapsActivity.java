...
import com.arshiya.mapsapi.locationdatamanager.LocationDetailsGetter;
import com.arshiya.mapsapi.locationdatamanager.PlacesAutocomplete;
...
public class MapsActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onMapClick(LatLng latLng) {
        ...
        if (size == Constants.MAX_GEOFENCE_SIZE) {
            ...
            AlertDialogClass.showAlert(MapsActivity.this, getResources().getString(R.string.geofence_max_limit_reached));
        } else {
...
//                loadGeofences();
    ...
    private void createGeofence() {
        ...
        geofenceCallbacks.createGeofence(mGoogleApiClient, mGeofencePendingIntent, mSelectedLatLng, mGeofenceResultCallback);
