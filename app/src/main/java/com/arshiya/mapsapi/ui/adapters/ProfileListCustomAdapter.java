...
/**
 * Created by arshiya on 11/2/2015.
 */
public class ProfileListCustomAdapter extends CursorAdapter {

  private static final String TAG = ProfileListCustomAdapter.class.getSimpleName();
  private AdapterCallback mAdapterCallback;
  private Context mContext;
  private ProfileManagerSharedPref mManagerSharedPref;

  public ProfileListCustomAdapter(Context context, Cursor c, int flags) {
