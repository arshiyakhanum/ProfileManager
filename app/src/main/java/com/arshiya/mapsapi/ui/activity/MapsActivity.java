...
public class MapsActivity extends FragmentActivity
  ...
  private void createGeofence() {
    ...
    mGeofencePendingIntent =
        geofenceCallbacks.getGeofencePendingIntent(MapsActivity.this, mGeofencePendingIntent);
    geofenceCallbacks.createGeofence(mGoogleApiClient, mGeofencePendingIntent, mSelectedLatLng,
